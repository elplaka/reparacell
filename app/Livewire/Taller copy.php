...
class Taller extends Component
{
    ...
    public function updatedBusquedaEquiposEntregados($value)
    {
        if ($value == 0)
        {
            $this->busquedaEquipos['idEstatus'] = [1,2,3,4];
        }
        elseif ($value == 1)
        {
        ...
        {
            $this->busquedaEquipos['idEstatus'] = null;
        }
    }
    ...
    public function updatedBusquedaEquiposIdEstatus()
    {
        // dd('prueba');
    }
