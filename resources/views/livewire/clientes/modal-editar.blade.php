                ...
                <div class="container mt-3">
                    <div class="row mb-3">
                        <div class="col-md-4 mb-3">
                            <label for="clienteModal.id" class="form-label text-gray-700" style="font-weight:500;font-size:11pt"> Id </label>
                            <input wire:model="clienteModal.id" type="text" class="input-height form-control w-100" id="clienteModal.id" style="font-size:11pt;" readonly autofocus>
                        </div>
                        <div class="col-md-4 mb-3">
