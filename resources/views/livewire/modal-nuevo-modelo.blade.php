             ...
             <div class="modal-body" wire:loading.remove>
                <div class="container mt-3">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-9">
                            <select wire:model.live="modeloMod.idMarca" type="text" class="select-height form-control" id="modeloMod.idMarca" style="font-size:11pt;" autofocus wire:key={{ $marcaMod['idTipoEquipo'] }}>
