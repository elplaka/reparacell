<div wire:ignore.self class="modal fade" id="nuevaMarcaModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" data-backdrop="static">
    <div class="modal-dialog modal-sm" role="document" >
       <div class="modal-content">
           <div class="modal-header">
               <h1 class="text-xl font-bold"><b> Agregar marca</b></h1>
           ...
           <div class="modal-body" wire:loading.remove>
               <div class="container mt-3">
                   ...
                   <div class="row mb-3">
                       <label for="marcaMod.nombre" class="col-md-3 block text-sm-right text-gray-700 pr-0" style="font-size:10pt;">{{ __('Nombre') }}</label>
                       <div class="col-md-9">
               ...
               <div class="modal-footer d-flex justify-content-center">
                   @if (!$guardoMarcaOK)
                   <button class="btn btn-primary uppercase tracking-widest font-semibold text-xs" wire:click="guardaMarca">Guardar</button>
                   @endif
