...
<div>
    ...
    @if ($showMainErrors)
        ...
        @endif --}}
    @endif
    <div wire:ignore.self class="collapse" id="collapseAgregaEquipoTaller" wire:loading.class="d-none"
    wire:model="muestraDivAgregaEquipo">
            ...
            <div class="container mt-3">
                <div class="row">
                    ...
                    <div class="col col-md-3">
                            ...
                            <div class="col-md-5">
                            {{-- <button class="btn btn-secondary" data-toggle="modal" data-target="#buscarClienteModal" style="font-size: 10pt" wire:click.prevent="abreModalBuscarCliente">
