<div>
    ...
    <div class="modal-header"@if (!$muestraDivAgregaEquipo) style="display: none" @endif>
        <span>
            @if ($equipoTaller['estatus'] == 3)
    ...
    <div class="modal-body" @if (!$muestraDivAgregaEquipo) style="display: none" @endif>
        <div class="rounded p-3 border"> 
            <h3 class="mt-n4 ml-n2">
                <span class="bg-white text-gray-700 uppercase tracking-wider" style="font-size: 11pt"> <strong>&nbsp; CLIENTE &nbsp;</strong></span>
                @if ($cliente['estatus'] == 1) &nbsp;&nbsp;&nbsp;&nbsp; <span class="uppercase tracking-wider" style="background-color:green; color:white; vertical-align:top; font-size: 8pt">&nbsp;Nuevo&nbsp;</span> @endif
            </h3>
                ...
                <div class="row">
                    ...
                    <div class="col col-md-3">
                        {{-- <div class="d-flex justify-content-between align-items-center"> --}}
                            <div class="row">
                            <div class="col-md-7">
                            <input wire:model.live="cliente.telefono" type="text" class="input-height form-control" id="cliente.telefono" wire:keydown="validarNumeros" style="font-size: 11pt;" @if ($equipoTaller['estatus'] == 3) readonly @endif autofocus>
                            </div>
                            <div class="col-md-5">
                            <button class="btn btn-secondary" data-toggle="modal" data-target="#buscarClienteModal" style="font-size: 10pt" wire:click="abreModalBuscarCliente">
                    ...
                    @if (!$cliente['publicoGeneral'])
                        @if (strlen($cliente['telefono']) == 10 || $cliente['estatus'] == 3)
                            <div class="col col-md-8 d-flex justify-content-end">
                                ...
                                @elseif ($cliente['estatus'] == 3 && $equipo['estatus'] != 3)   {{-- Cliente para editar --}}
            ...
            <div class="container mt-3">
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <input wire:model="cliente.nombre" type="text" class="input-height form-control" id="cliente.nombre" style="font-size:11pt;" @if($cliente['estatus'] == 2 || $equipoTaller['estatus'] == 3) readonly @endif autofocus>
                    </div>
                    ...
                    <div class="col-md-2 mb-2">
                        <input wire:model="cliente.telefonoContacto" type="text" class="input-height form-control" id="cliente.telefonoContacto" style="font-size:11pt;" wire:keydown="validarNumeros" @if($cliente['estatus'] == 2 || $equipoTaller['estatus'] == 3) readonly @endif autofocus>
                    </div>
                    @endif
                </div>
            </div>
        ...
        @if (strlen($cliente['telefono']) == 10)
            ...
            <div class="rounded p-3 border"> 
                <h3 class="mt-n4 ml-n2">
                    <span class="bg-white text-gray-700 uppercase tracking-wider" style="font-size: 11pt"> <strong>&nbsp; EQUIPO &nbsp;</strong></span>
                ...
                <div class="container mt-3">
                    <div class="row">
                        ...
                        <div class="col-md-2 d-flex align-items-center">
                            @if ($equipo['estatus'] == 1  || $equipo['estatus'] == 3)
                        ...
                        <div class="col col-md-3 d-flex justify-content-end">
                            @if ($equipo['estatus'] == 2)   {{-- Equipo ya existente --}}
                            ...
                            @elseif ($equipo['estatus'] == 3 && $cliente['estatus'] != 3)   {{-- Equipo para editar --}}
        ...
        <div class="modal-footer d-flex justify-content-end">
            @if (strlen($cliente['telefono']) == 10)
                @if ($equipo['estatus'] == 3)  {{-- Editando el equipo en taller --}}
                ...
                @endif
            @endif
            <button class="btn btn-danger uppercase tracking-widest font-semibold text-xs" wire:click="descartaEquipo">Descartar</button>
       </div>
    </div>
    <span wire:loading>Cargando... <i class="fa fa-spinner fa-spin"></i> </span>
</div>
