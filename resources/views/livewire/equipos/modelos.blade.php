<div class="w-full min-h-screen mt-3 font-sans text-gray-900 antialiased">
    ...
    <div class="row">  {{-- El wire:ignore en el div exterior evita que desaparezcan los selectpickers de dentro --}}
        ...
        <div class="col-md-3 mb-3">
            ...
            <select wire:model.live="filtrosModelos.idMarca" type="text" class="select-height form-control w-100" id="filtrosModelos.idMarca" style="font-size: 11pt;">
            ...
            <tbody>
                ...
                <tr style="font-size: 10pt;">
                    ...
                    <td class="px-2 py-1 whitespace-no-wrap" style="vertical-align: middle">
                      ...
                      <td class="px-2 py-1 whitespace-no-wrap" style="vertical-align: middle">
                        <a wire:click="editaModelo({{ $modelo->id }})" wire:target="editaModelo" title="Editar modelo" wire:loading.attr="disabled" style="color: dimgrey; cursor:pointer;"
                            {{-- data-toggle="modal" data-target="#editarModeloModal"     --}}
                            >
