                     ...
                     <div class="row mb-2" style="border-bottom: 1px solid #ccc;">
                         ...
                         <div class="col-md-3 p-0" style="border-right: 1px solid #ccc;">
                             ...
                             <div class="d-flex align-items-center">
                                 ...
                                 <input type="number" step="any" wire:key="input-cobro-realizado" wire:model.live.debounce.500ms="cobroFinal.cobroRealizado" class="form-control ml-2" style="color: rgb(83, 83, 83); font-size: 11pt; border: none;">
                     ...
                     <div class="row mb-2" style="border-bottom: 1px solid #ccc;">
                         ...
                         <div class="col-md-6 p-0">
                             ...
                             <div class="d-flex align-items-center">
                                 ...
                                 <input type="number" step="any" wire:key="input-cobro-realizado-2" wire:model.live.debounce.400ms="cobroFinal.cobroRealizado" class="form-control ml-2" style="color: rgb(83, 83, 83); font-size: 11pt; border: none;">
                                 @error('cobroFinal.cobroRealizado')
                                 <span class="text-danger">{{ $message }}</span>
                                 @enderror
                             </div>
