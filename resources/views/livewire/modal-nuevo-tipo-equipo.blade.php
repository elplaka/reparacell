<div wire:ignore.self class="modal fade" id="nuevoTipoEquipoModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" data-backdrop="static">
           ...
           @endif
            <div class="modal-body" wire:loading.remove>
               ...
               <div class="modal-footer d-flex justify-content-center">
                   ...
                   @endif
                   <button class="btn btn-secondary uppercase tracking-widest font-semibold text-xs" data-dismiss="modal" wire:click="cierraTipoEquipoModal">Cerrar</button>
               </div>
           </div>
       </div>
   </div>
